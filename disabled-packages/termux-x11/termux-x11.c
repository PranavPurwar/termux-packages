...
# define TERMUX_PREFIX "/data/data/org.cosmicide/files/usr"
#endif

#ifndef TERMUX_X11_DIR
# define TERMUX_X11_DIR "/data/data/org.cosmicide.x11/"
#endif
...
int main(int argc, char *argv[]) {
	...
	char *server_argv[] = {TERMUX_PREFIX "/bin/am", "start", "-n", "org.cosmicide.x11/.MainActivity", NULL};
